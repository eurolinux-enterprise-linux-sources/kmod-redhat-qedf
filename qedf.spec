...
%define kmod_driver_version	8.10.7.0_dup7.4
...
rpm -ql kmod-redhat-qedf-%{kmod_driver_version}-%{kmod_rpm_release}%{?dist}.$(arch) | \
...
%changelog
* Tue Dec 19 2017 Eugene Syromiatnikov <esyr@redhat.com> 8.10.7.0_dup7.4-2
- Do not call dracut on non-existing kernel

* Thu Dec 14 2017 Eugene Syromiatnikov <esyr@redhat.com> 8.10.7.0_dup7.4-1
